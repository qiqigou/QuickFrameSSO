...
namespace QuickFrameSSO.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(
            ...
            TestUserStore users/*, IDataProtectionProvider provider*/)
        {
            _users = users;
            ...
            //_protector = provider.CreateProtector("IdentityServer4.Stores.ProtectedDataMessageStore");//研究IdentityServer4源码是发现的
        }
        ...
        private async Task<LoggedOutViewModel> BuildLoggedOutViewModelAsync(string logoutId)
        {
            ...
            //    try
            //    {
            //        var bytes = Base64Url.Decode(logoutId);
            //        bytes = _protector.Unprotect(bytes);
            //        var json = Encoding.UTF8.GetString(bytes);
            //        Message<LogoutMessage>? result = ObjectSerializer.FromString<Message<LogoutMessage>>(json);
            //    }
            //    catch (Exception ex)
            //    {
            ...
            var vm = new LoggedOutViewModel
            {
                ...
                PostLogoutRedirectUri = logout?.PostLogoutRedirectUri ?? "/",//退出后的重定向路径
